...
- `gh run list --repo SokratesAI/agora-persona-runner --branch main --limit 1`
  — the build that produced it went green.
...
```bash
cd /data/workspace/agora-persona-runner
set -e   # the exit codes below are worthless if the next line runs anyway
