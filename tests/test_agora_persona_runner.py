...
def drainable_main():
    ...
    # And the recap refresher (Cycle 1508, his issue #219), a daemon thread
    # that rewrites the Journal card whenever the journal changes. Same
    # reason again; the wire is asserted in tests/test_recap_refresh.py.
