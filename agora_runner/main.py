...
def main():
    ...
    # with Haiku on the subscription (issues.md #219). Same argument as the
    # catalog above: a card each cycle has to choose to rewrite is a card a
    # busy cycle skips, and it was 3.9h stale when I wired this in.
    start_recap_refresh()
